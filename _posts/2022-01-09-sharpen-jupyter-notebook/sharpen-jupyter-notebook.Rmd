...
1. **web-based** computational environment for creating notebook documents (formally `ipython` notebook, that's why its extension is `.ipynb`).    
...
```{r,out.width = "60%", fig.align = "left", fig.cap ="Cell Type ", echo = FALSE}
