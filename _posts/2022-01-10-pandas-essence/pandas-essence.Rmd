...
|                                               |                                                                       |
|-----------------------------------------------|-----------------------------------------------------------------------|
| _plot histogram of specific column/attribute_ | **df['col'].plot**( kind ='hist', bins = , figsize =(, ), title= ' ') |
| _line plot of specific column_                | **df['col'].plot()**                                                  |
| _smoothing line plot of specific column_      | **df['Manual'].rolling(3).mean().plot()**                             |
