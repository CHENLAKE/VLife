...
## A surprisingly effortless but successful project experience 
...
## Why least effort but most effective?   

Upon completion of that project in May 2021, I couldn’t help giving gratitude to Yongkai (my teammate) since I felt that I didn’t “do” much of the work (since I didn’t have that exhaustive feeling as in other projects thus, I assumed I didn’t do much).

Surprisingly, Yongkai conveyed his thanks to me for all my ideas and questioning of the details in the project. He said he is the kind of person good at effective execution and enjoying finding tech solutions, but he needs clear directions (e.g., I came up with the problem that our project resided on),but he couldn’t  naturally think out of the box or raised the question I had during the project…

All in all, it turns out the best outcome comes not from hard work but from the coincidence that our aptitudes fit each other’s perfectly, the fact that we only need to contribute in what we are good at made everyone’s life easy and effortless!

## Key takeaways from this experience   

* If possible, matching team with complementary skills.

* Each one has his own field that can generate expertise and passion, if we want a great piece of work to deliver, we need to know them well so that we can put them in their most suitable position. 

* Focus is important to those who need to carry out the work unless a coarse deliverable is expected. 

## What about the ability to change  
...
Each water molecule in the ocean needs to perform the function no more than what a H2O molecule can do. It is the system that forms another disparate existence – the ocean.   

```{r,out.width = "81%", fig.align = "center", echo = FALSE}
knitr::include_graphics("pic/oceanship.jpeg")
```
