...
description: |
  Resources of learning API& POSTMAN from basic concepts. Steps of setting up OAuth2.0 authentication for Google cloud API and how to send Google-DOC-AI processing request in POSTMAN.
author:
  - name: V.LC.LAKE
    url: {}
date: 12-06-2021
...
function : to extract feilds relavent to DHL business
"""
