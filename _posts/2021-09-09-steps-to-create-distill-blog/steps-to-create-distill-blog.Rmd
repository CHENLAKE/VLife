...
* After creating a distill blog project(*VLife*), the structure of the blog is automatically created, including 1 *index*,1 *about* and a *welcome* page(in *_posts/welcome/welcome.Rmd*),two folders(_posts, _site) as well as 1 yaml file(_site.yml)
