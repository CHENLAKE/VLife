...
description: |
  Markdown can be used in many places, such as jupyter notebook, R studio to create distill blog or creating html, word or pdf report. Some tips & resources are commonly used. 
author:
  - name: V.LC.LAKE
    url: {}
date: 12-17-2021
